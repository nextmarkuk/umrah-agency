        ...
        <div class="container">
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">Rs. 262,000</span> per person
                </div>
