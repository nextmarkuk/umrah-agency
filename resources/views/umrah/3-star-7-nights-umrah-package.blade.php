        ...
        <div class="container">
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">Rs. 244,500</span> per person
                </div>
