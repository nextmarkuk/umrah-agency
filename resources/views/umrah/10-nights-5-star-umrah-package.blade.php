        ...
        <div class="container">
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">Rs. 285,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Experience a blessed Umrah journey with Umrah Agency. This 10-night luxury package is designed for maximum comfort and spiritual focus. Enjoy the convenience of premium accommodation near the Holy Mosques in both Makkah and Madinah, with all essentials handled by our professional team.</p>
                    </div>
