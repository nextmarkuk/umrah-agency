        ...
        <div class="container">
            ...
            <div class="pkg-price-bar">
                <div class="price-text text-white">
                    FROM <span class="text-white">Rs. 276,000</span> per person
                </div>
            ...
            <div class="row">
                <div class="col-lg-8">
                    ...
                    <div class="section-card">
                        ...
                        <p class="description text-justify">Embark on a meaningful 12-night spiritual journey with Umrah Agency. This 3-star package offers the perfect balance of comfort and affordability, featuring well-located hotels in Makkah and Madinah. We handle all logistics including flights and visa, so you can devote your time to prayer and reflection.</p>
                    </div>
