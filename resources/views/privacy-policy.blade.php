...
<meta name="description" content="Read our privacy policy and learn how we protect your personal data at Umrah Agency Pakistan.">
@endsection
@section('content')
@section('content')
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="section-card shadow-sm">
                    <p class="lead mb-4 font-weight-bold">Umrah Agency understands and respects the importance of your privacy and we are committed to safeguarding your personal information.</p>
                    ...
                    <div class="legal-section mt-5">
                        ...
                        <p><strong>Umrah Agency</strong> collects personal information about travelers when a booking is made. We store traveler profiles to save you typing these details each time you make a booking. This information is only used to fulfill booking and other requests.</p>
                    </div>
